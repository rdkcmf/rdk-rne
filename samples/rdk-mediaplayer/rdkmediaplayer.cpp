...
rtDefineMethod    (RDKMediaPlayer, suspend);
rtDefineMethod    (RDKMediaPlayer, resume);
...
rtError RDKMediaPlayer::suspend()
{
    LOG_INFO("RDKMediaPlayer is going to suspend\n");
    // Free all resources
    stop();
...
rtError RDKMediaPlayer::resume()
{
    LOG_INFO("RDKMediaPlayer is going to resume\n");
    // Start playing again
    onInit();
